...
class TestRainDebugger:
    ...
    def test_rain_frequency_scaling(self):
        ...
        if loss1 == 0:
            # If first loss is zero, second loss should also be zero
            assert loss2 == 0, f"Expected zero loss when first loss is zero, but got {loss2}"
        else:
    ...
    def test_rain_distance_scaling(self):
        ...
        if loss1 == 0:
            # If first loss is zero, second loss should also be zero for scaling to hold
            assert loss2 == 0, f"Expected zero loss when first loss is zero, but got {loss2}"
        else:
